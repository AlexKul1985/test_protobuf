...
proto.Employees.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      msg.getEmployeesList().push(value);
      msg.setEmployeesList(msg.getEmployeesList());
      break;
    default:
      reader.skipField();
      break;
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.Employees.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getEmployeesList();
  if (f.length > 0) {
 ...
 * @return {!proto.Employees} The clone.
 */
proto.Employees.prototype.cloneMessage = function() {
  return /** @type {!proto.Employees} */ (jspb.Message.cloneMessage(this));
};
